...
<div class="service_details">
    <div class="container-fluid">
        <div class="row">
            <div class="col-1">
                <img src="{{ asset('/assets/img/logo/clone.png') }}" alt="clone"/>
            </div>
            <div class="col-2">
                <h1>Clone to Website</h1>
                <p>Do you want to copy, clone, duplicate any website. Then you are Welcome to WorldSoftZone, you are in the right place. We are offering website copy, clone, duplicate services. Let's see what we are offering.</p>
                ...
                <div class="in-content">
                    ...
                    <h2>We will do</h2>
                    <ul>
                        <li>Pixel perfect clone design.</li>
                    ...
                    <div class="action">
                        <?php echo FunctionsController::get_a_quote('clone') ;?>
                    </div>
                </div>
