...
<div class="service_details">
    <div class="container-fluid">
        <div class="row">
            <div class="col-1">
                <img src="{{ asset('/assets/img/logo/pdf.png') }}" alt="pdf"/>
            </div>
            <div class="col-2">
                <h1>PDF to Website</h1>
                <p>You have PDF template and now want to convert it to web pages?  Welcome to WorldSoftZone, you are on the right place. We are offering Canva to dynamic Website conversion services. Let's see what we are offering.</p>
                ...
                <div class="in-content">
                    ...
                    <div class="action">
                        <?php echo FunctionsController::get_a_quote('pdf') ;?>
                    </div>
                </div>
