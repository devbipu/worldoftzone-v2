...
<div class="service_details">
    <div class="container-fluid">
        <div class="row">
            <div class="col-1">
                <img src="{{ asset('/assets/img/logo/figma.png') }}" alt="figma"/>
            </div>
            <div class="col-2">
                <h1>Figma to Website</h1>
                <p>You have Figma template and now want to convert it to web pages?  Welcome to WorldSoftZone, you are on the right place. We are offering Figma  to dynamic Website conversion services. Let's see what we are offering.</p>
                ...
                <div class="in-content">
                    ...
                    <h2>We will do</h2>
                    <ul>
                        <li>Pixel perfect Figma to HTML design.</li>
                    ...
                    <div class="action">
                        <?php echo FunctionsController::get_a_quote('figma') ;?>
                    </div>
                </div>
