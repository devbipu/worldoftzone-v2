...
<div class="service_details">
    <div class="container-fluid">
        <div class="row">
            <div class="col-1">
                <img src="{{ asset('/assets/img/logo/xd.png') }}" alt="xd"/>
            </div>
            <div class="col-2">
                <h1>XD to Website</h1>
                <p>You have XD template and now want to convert it to web pages?  Welcome to WorldSoftZone, you are on the right place. We are offering XD  to dynamic Website conversion services. Let's see what we are offering.</p>
                ...
                <div class="in-content">
                    ...
                    <h2>We will do</h2>
                    <ul>
                        <li>Pixel perfect XD to HTML design.</li>
                    ...
                    <div class="action">
                        <?php echo FunctionsController::get_a_quote('xd') ;?>
                    </div>
                </div>
